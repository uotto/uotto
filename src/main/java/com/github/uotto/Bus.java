...
public class Bus {
     ...
     */
    Bus(String identifier, HandlerFinder handlerFinder) {
    ...
    public void unregister(Object object) {
        Objects.requireNonNull(object, "Object to unregister must not be null.");
    ...
    public void post(Object event) {
        Objects.requireNonNull(event, "Event to post must not be null.");
