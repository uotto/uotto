...
class EventProducer {
    ...
    EventProducer(Object target, Method method) {
        this.target = Objects.requireNonNull(target, "EventProducer target cannot be null.");
        this.method = Objects.requireNonNull(method, "EventProducer method cannot be null.");
