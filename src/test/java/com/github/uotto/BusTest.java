...
public class BusTest {
    ...
    public void polymorphicDistribution() {
        ...
        assertEquals("Comparable fixture must be third object delivered.", COMP_EVENT, objectEvents.get(2));
    }
    ...
    public void producingNullIsNoOp() {
        ...
        assertEquals(Collections.singletonList("Foo"), catcher.getEvents());
    }
    ...
    public void unregister() {
        ...
        assertEquals("One correct event should be delivered.", Collections.singletonList(EVENT), catcher2.getEvents());
    ...
    @Test
    public void testExceptionThrowingHandler() throws Exception {
